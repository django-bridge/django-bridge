...
export default function Overlay({
  ...
  const requestCloseCallback = React.useCallback(({skipDirtyFormCheck = false}: {skipDirtyFormCheck?: boolean} = {}) => {
  ...
  const overlayContext: OverlayContextType = React.useMemo(
    ...
    [closeRequested, dirtyFormContext.isDirty, onCloseCompleted, requestCloseCallback]
  );
