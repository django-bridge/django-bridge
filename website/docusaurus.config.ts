...
const config: Config = {
  ...
  tagline: 'Djream is a framework for building lightweight React SPAs fpr Django applications. Use Django views and forms for logic and React for presentation.',
