...
const config: Config = {
  ...
  tagline: 'Djream is a framework for building lightweight React SPAs in front of Django applications. Use Django views and forms for all your business logic and React for presentation.',
