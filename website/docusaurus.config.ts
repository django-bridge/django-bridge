...
const config: Config = {
  ...
  tagline: 'Djream is a framework for building lightweight React SPAs for Django applications. Use Django views and forms for logic and React for presentation.',
