...
os.environ["DJANGO_SETTINGS_MODULE"] = "django_bridge.test.settings"
...
def runtests():
    ...
    only_django_bridge = r"^django_bridge(\.|$)"
    if args.deprecation == "all":
        ...
        warnings.filterwarnings(
            "default", category=DeprecationWarning, module=only_django_bridge
        )
        warnings.filterwarnings(
            "default", category=PendingDeprecationWarning, module=only_django_bridge
        )
    ...
    try:
        ...
        from django_bridge.test.settings import MEDIA_ROOT, STATIC_ROOT
